...
export default function SocialShare({ url, title, description = '', variant = 'default' }: SocialShareProps) {
    ...
    return (
        <div className="flex flex-wrap items-center gap-3">
            <span className="text-[10px] font-black uppercase tracking-widest text-gray-400 mr-2">Share Berita:</span>

            <a
                href={shareLinks.whatsapp}
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center space-x-2 bg-[#25D366] text-white px-4 py-2 rounded-none font-bold text-xs uppercase tracking-widest hover:brightness-110 transition-all shadow-lg shadow-[#25D366]/20"
            >
            ...
            <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center space-x-2 bg-[#1877F2] text-white px-4 py-2 rounded-none font-bold text-xs uppercase tracking-widest hover:brightness-110 transition-all shadow-lg shadow-[#1877F2]/20"
            >
                <div className="w-4 h-4 fill-current">
            ...
            <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center space-x-2 bg-black text-white px-4 py-2 rounded-none font-bold text-xs uppercase tracking-widest hover:bg-gray-800 transition-all"
            >
                <div className="w-4 h-4 fill-current">
