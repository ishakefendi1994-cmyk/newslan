...
import { Save, ChevronLeft, Image as ImageIcon, Loader2, Check, AlertCircle } from 'lucide-react'
        ...
        <div className="space-y-8 pb-20">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-black tracking-tighter">New Banner</h1>
                        <p className="text-gray-500 text-sm">Create a high-impact slide for the homepage</p>
                    </div>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div className="lg:col-span-5 space-y-6">
                    ...
                    <div className="bg-black/5 p-6 rounded-3xl border border-black/5 space-y-4">
                        <p className="text-xs font-bold text-black/60 uppercase tracking-widest flex items-center space-x-2">
                            <AlertCircle className="w-3 h-3" />
                            <span>Pro Tip</span>
                        </p>
                        <p className="text-xs text-black/40 leading-relaxed font-medium">
                            Use high-quality panoramic images. Ideally, place important text or logos in the center to avoid clipping on mobile devices.
                        </p>
                    </div>
                </div>
            </div>
